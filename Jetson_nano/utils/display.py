...
def show_fps(img,fps,angle):
    ...
    cv2.putText(img,"Angle: {}".format(angle),(11, 35),font,1.0,(32, 32, 32),4,line)

    cv2.putText(img,"Angle: {}".format(angle),(10, 35),font,1.0,(240, 240, 240),1,line)
